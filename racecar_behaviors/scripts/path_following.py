...
class PathFollowing:
    def __init__(self):
        ...
        self.balloon_path = r'/home/emile/racecar/debris'
    ...
    def goal_reached_callback(self,goal_status, result):
        ...
        if (self.goals[0][1] == "balloon"):
            self.goals.pop(0)
            msg_balloon = rospy.wait_for_message('position_balloon',Float32MultiArray)
            goal = self.create_goal(goal_x, goal_y, self.current_angle + msg_balloon.data[3], "picture")
    ...
    def odom_callback(self, msg):
        ...
        self.current_posX = msg.pose.pose.position.x
        pass
    ...
    def balloon_callback(self,msg):
        ...
        if distance <=3.5:
            ...
            if new_balloon:
                ...
                distance = 1.8 # From the blob to take the picture
                if self.current_posX > pos_x:
                    goal_x = pos_x + distance
                else:
                    goal_x = pos_x - distance
